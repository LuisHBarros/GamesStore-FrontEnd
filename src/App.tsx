...
function App() {
  ...
  return (
    ...
    <nav className='text-center'>
      ...
      <Link className="p-2 text-lg text-black inline-block my-0 mx-2.5 hover:text-green-500 font-semibold text-[1em] transition-all duration-300" to='registerproduct'>Register Product</Link>
      {auth.user && <Link className="text-black inline-block my-0 mx-2.5 hover:text-green-500 font-semibold text-[1em] transition-all duration-500" to='/cart' onClick={handleLogout}>Carrinho</Link>}
